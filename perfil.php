<?php
	...
	if ($_SESSION['nomeu']) {
		...
		$sql_log = "SELECT * FROM usuarios WHERE nome = '".strtoupper($_SESSION['nomeu'])."'";

		$query_log = mysqli_query($conexao, $sql_log);

		$infos = mysqli_fetch_assoc($query_log);
...
<html lang="en">
<head>
	<title>Perfil - <?php echo $infos['nome']?></title>
	<meta charset="UTF-8">
...
<body class="animsition">
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-40 p-b-50 flex-col-c-m" style="background-image: url(<?php

		$foto = 'images/fotos_perfil/'.$infos['urlImg'];
		...
		if ($largura >= 1920 && $altura >= 239) {
			...
			echo "images/heading-pages-01.jpg";
		}
		?>);">
		<h2 class="l-text2 t-center">
			Perfil - <?php echo $infos['nome']?>
		</h2>
	</section>
	...
	<section class="bgwhite p-t-66 p-b-60">
		<div class="container">
			<div class="row">
					<div class="col-md-3">
						<a style="text-decoration: none;" href="?acao=infos" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
								Informações
						</a>
					</div>
					<div class="col-md-3">
						<a style="text-decoration: none;" href="?acao=ped" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
								Pedidos
						</a>
					</div>
					<div class="col-md-3">
						<a style="text-decoration: none;" href="?acao=config" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
								Configurações
						</a>
					</div>
					<div class="col-md-3">
						<a style="text-decoration: none;" href="?acao=sair" class="flex-c-m size1 bg1 bo-rad-20 hov1 s-text1 trans-0-4">
								Sair
						</a>
					</div>
					...
					<?php
						...
						if (isset($_GET['acao'])) {
							if ($_GET['acao'] == 'sair') {
								require('sair.php');
							} else if ($_GET['acao'] == 'config') {
								include('configuracoes.php');
							} else if ($_GET['acao'] == 'infos') {
								include('infos.php');
							} else if ($_GET['acao'] == 'ped') {
								include('pedidos.php');
							}
						}
